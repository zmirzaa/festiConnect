...
<div class="container-fluid">
      <nav id="navbar" class="navbar navbar-light px-3 border-bottom">
      	<div>
	        <h1>FestiConnect</h1>       
	        <h5 class="fw-bold mt-2">Hey Festi ${loginUser.userName}!</h5>
        </div>
	        		...
	        		<div class="list-group w-auto"> 
			        	...
			        	<c:forEach var="review" items="${allReviews}">
				        	<c:if test="${loginUser.id == review.reviewCreator.id}">
							  <a href="/review/${review.id}" class="list-group-item list-group-item-action d-flex gap-3 py-3 bg-dark" aria-current="true">
