...
<div class="container-fluid">
      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
      	<h3 class="text-center mt-2">Hey Festi <c:out value="${loginUser.userName}"/>!</h3>
        <div class="d-flex gap-5 justify-content-evenly mb-5 mt-5">
        		<div class="list-group w-auto"> 
	        		<h4 class="text-center title-pages">your reviews</h4>
		        	<c:forEach var="review" items="${allReviews}">
			        	<c:if test="${loginUser.id == review.reviewCreator.id}">
						  <a href="/review/${review.id}" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
						    <div class="d-flex gap-2 w-100 justify-content-between align-items-center">
						      <div>
						        <h6 class="mb-0">${review.festivalName} ${review.yearAttended}</h6>
			...
			<div class="list-group w-auto"> 	
				<h4 class="text-center title-pages">your alerts</h4>
				<c:forEach var="alert" items="${alerts}">
					<c:if test="${loginUser.id == alert.alertCreator.id}">
						 <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
						 <div class="d-flex gap-2 w-100 justify-content-between align-items-center">
						  <div>
						   <h6 class="mb-0">${alert.festivalName}</h6>
						   <small class="mb-0 text-muted">${alert.description}</small>
						  </div>
